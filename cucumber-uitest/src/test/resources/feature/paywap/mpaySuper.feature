...
#登录
	...
	#直接使链接跳转到点击超级会员应跳的页面
	Then I gettohrefurl css "a[data-clickid='supervip']" 
#	Then I wait for load 5 sec 
	...
	#选择超级
	Then executejs css "body > div.wrap > div > div.pay_main > div.pay_type > ul > li:nth-child(2)"
	...
	Then I wait for 7 sec 
	#校验超级下单的金额
	Then check order_data from db whith param "150020403" should be "288.00"
