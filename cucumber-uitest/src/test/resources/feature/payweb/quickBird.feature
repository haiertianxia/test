Feature: quickBird
  ...
  Scenario Outline:    
   ...
   #点击快鸟开通
   Then I click on element having css "body > div.g-main.g-main_pay > div > div > div > section.u-sec.noborder > ul > li:nth-child(1) > a"
   Then I wait for 3 sec  
   Then I switch to new window having title "迅雷支付中心"
   Then I wait for 3 sec
   Then I click on element having css "#tab-supervip"
   Then I wait for 3 sec  
   #点击单月
   ...
   Then I wait for 6 sec
   #点击快鸟开通
   Then I click on element having css "#l_tabs.viptab_wp > ul:nth-child(1) > li:nth-child(1)"
   Then I wait for 3 sec
   #点击单月
   Then I click on element having css "#l_tabcont > div.choicebox_wp.tab_area.mb30 > div.choicebox.lastdiv > span.tip" 
   Then I wait for 2 sec
