...
public class PayWapGameTest {
    ...
    public void setUp(String driverType) {
       ...
       // BoxDriver.baseDriver = (WebDriver) baseDriver;
    }
    ...
    public void testLogin() throws Exception {
        ...
        for (CSVRecord row : csvData) {
            ...
            wapPayPage.chooseOutNumber(wapPayPage.gameOut);
            Thread.sleep(4000);
            WaitUtil.waitForLoad(driver.getWebDriver());
            Thread.sleep(4000);
            ...
            wapPayPage.chooseInNumber(wapPayPage.gameIn);//下单页面选择普通网游
            Thread.sleep(3000);
            WaitUtil.waitForLoad(driver.getWebDriver());
            Thread.sleep(4000);//必须要休眠，否则拍的图片仍是切换前的
