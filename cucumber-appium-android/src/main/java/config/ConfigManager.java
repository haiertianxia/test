...
public class ConfigManager {
    ...
    static {
        ...
        try {
            defaultProperties.load(new FileReader("src/test/resources/config/default.properties"));
            File customConfigFile = new File("src/test/resources/config/custom.properties");
